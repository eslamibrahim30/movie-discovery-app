			...
			<div className="w-full max-w-110 space-y-10">
				...
				<div className="flex flex-col items-center text-center space-y-6">
					...
					<div className="space-y-2">
						...
						<p className="text-muted-foreground text-base">{t.desc}</p>
					</div>
				</div>
				...
				<div className="border-t border-border/50 pt-8 mt-8 text-center">
					<p className="text-sm text-muted-foreground">
						{t.noAccount}{" "}
						<Link to="/register" aria-label="Go to register page" className="text-primary font-bold hover:text-primary/80 transition-colors">
